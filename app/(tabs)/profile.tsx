...
export default function Profile() {
  ...
  const getAvatar = (seed: string) =>
    `https://api.dicebear.com/7.x/initials/png?seed=${encodeURIComponent(seed)}&&backgroundColor=1B1B1B`;
  const handleLogout = () => {
    setLoggedIn(false);
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.detailsCard}>
              ...
              <Text style={[styles.profileInfo ,{paddingTop:20 , paddingLeft : 20}]}>Personal Info</Text>
...
const styles = StyleSheet.create({
  ...
  detailsIcon: { justifyContent: "flex-start", paddingLeft: 15 , color: "#19aa59" },
